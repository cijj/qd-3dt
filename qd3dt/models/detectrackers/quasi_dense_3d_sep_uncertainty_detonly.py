...
class QuasiDense3DSepUncertaintyDetonly(BaseDetector, RPNTestMixin, BBoxTestMixin,
                                 Analyze3DMixin):
    ...
    def __init__(self,
                 ...
                 test_cfg=None,
                 pretrained=None):
        super(QuasiDense3DSepUncertaintyDetonly, self).__init__()
    ...
    def init_weights(self, pretrained=None):
        super(QuasiDense3DSepUncertaintyDetonly, self).init_weights(pretrained)
