# model settings
model = dict(
    type='QuasiDense3DSepUncertaintyImgFoolEmbed',
...
optimizer = dict(
    type='SGD',
    lr=0.00125, # single GPU, imgs_per_gpu=2
    momentum=0.9,
    weight_decay=0.0001,
...
log_level = 'INFO'
load_from = 'work_dirs/KITTI/seperate_train/quasi_subtrain_detonly/latest.pth'
# load_from = None
resume_from = None
workflow = [('train', 1)]
